package com.example.weddingplanner.allLeading.roomDatabase.guest;
...
public class GuestRowModel extends BaseObservable implements Parcelable {
    ...
    public GuestRowModel() {
        this.eventId = AppPrefLeading.getCurrentEvenId(MyApp.getInstance());
        this.name = "";
        this.genderType = 1;
        this.stageType = 1;
        this.note = "";
    ...
    public String getCurrentIdPref() {
        return AppPrefLeading.getCurrentEvenId(MyApp.getInstance());
    }
