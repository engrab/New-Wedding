...
import com.example.weddingplanner.allLeading.adapter.SubTaskAdapterLeading;
...
public class AddEditTaskActivityLeading extends BaseActivityRecyclerBindingLeading implements EasyPermissions.PermissionCallbacks, EasyPermissions.RationaleCallbacks {
...
//        this.binding.includedToolbar.setModel(this.toolbarModel);
    ...
    public void setCategoryListDialog() {
        ...
        this.dialogCategoryListBinding.recycler.setAdapter(new CategoryAdapterLeading(this.context, false, this.categoryList, new RecyclerItemClick() {
    ...
    public void setNewCatDialog() {
        ...
        this.dialogNewCatBinding.recycler.setAdapter(new ImageAdapterLeading(true, this.context, this.imageList, new RecyclerItemClick() {
            public void onClick(int i, int i2) {
    ...
    public void setRecycler() {
        ...
        this.binding.recycler.setAdapter(new SubTaskAdapterLeading(this.context, this.model.getArrayList(), new RecyclerItemClick() {
            public void onClick(int i, int i2) {
                if (i2 == 2) {
                    updateTotal();
                } else {
    ...
    public void openItemDetail(int i, SubTaskRowModel subTaskRowModel, boolean z) {
        Intent intent = new Intent(this.context, AddEditSubTaskActivityLeading.class);
        intent.putExtra(AddEditSubTaskActivityLeading.EXTRA_IS_EDIT, z);
        intent.putExtra(AddEditSubTaskActivityLeading.EXTRA_POSITION, i);
        intent.putExtra(AddEditSubTaskActivityLeading.EXTRA_MODEL, subTaskRowModel);
