package com.example.weddingplanner.allLeading.roomDatabase;
...
import com.example.weddingplanner.allLeading.roomDatabase.category.CategoryDao;
import com.example.weddingplanner.allLeading.roomDatabase.category.CategoryRowModel;
import com.example.weddingplanner.allLeading.roomDatabase.cost.CostDao;
import com.example.weddingplanner.allLeading.roomDatabase.cost.CostRowModel;
import com.example.weddingplanner.allLeading.roomDatabase.dbVerson.DbVersionDao;
import com.example.weddingplanner.allLeading.roomDatabase.dbVerson.DbVersionRowModel;
import com.example.weddingplanner.allLeading.roomDatabase.guest.GuestDao;
import com.example.weddingplanner.allLeading.roomDatabase.guest.GuestRowModel;
import com.example.weddingplanner.allLeading.roomDatabase.payment.PaymentDao;
import com.example.weddingplanner.allLeading.roomDatabase.payment.PaymentRowModel;
import com.example.weddingplanner.allLeading.roomDatabase.profile.ProfileDao;
import com.example.weddingplanner.allLeading.roomDatabase.taskList.SubTaskDao;
import com.example.weddingplanner.allLeading.roomDatabase.taskList.SubTaskRowModel;
import com.example.weddingplanner.allLeading.roomDatabase.taskList.TaskDao;
import com.example.weddingplanner.allLeading.roomDatabase.taskList.TaskRowModel;
import com.example.weddingplanner.allLeading.roomDatabase.vendor.VendorDao;
