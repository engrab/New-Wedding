...
import com.example.weddingplanner.allLeading.adapter.CompanionAdapterLeading;
...
import com.example.weddingplanner.allLeading.roomDatabase.guest.GuestRowModel;
...
public class AddEditGuestActivityLeading extends BaseActivityRecyclerBindingLeading implements EasyPermissions.PermissionCallbacks, EasyPermissions.RationaleCallbacks {
...
//        this.binding.includedToolbar.setModel(this.toolbarModel);
    ...
    public void deleteItem() {
        AppConstants.showTwoButtonDialog(this.context, getString(R.string.app_name), getString(R.string.delete_msg) + "<br /> <b>" + this.model.getName() + "</b>", true, true, getString(R.string.delete), getString(R.string.cancel), new TwoButtonDialogListener() {
            ...
            public void onOk() {
                try {
                    AddEditGuestActivityLeading.this.db.guestDao().deleteAllComp(AppPrefLeading.getCurrentEvenId(AddEditGuestActivityLeading.this.context), AddEditGuestActivityLeading.this.model.getId());
                } catch (Exception e) {
                    e.printStackTrace();
                }
                try {
                    AddEditGuestActivityLeading.this.db.guestDao().delete(AddEditGuestActivityLeading.this.model);
                } catch (Exception e2) {
                    e2.printStackTrace();
                }
                AddEditGuestActivityLeading.this.openItemList(true);
            }
        });
    }
    ...
    public void setRecycler() {
        ...
        this.binding.recycler.setAdapter(new CompanionAdapterLeading(this.context, this.model.getArrayList(), new RecyclerItemClick() {
            public void onClick(int i, int i2) {
                if (i2 == 2) {
                    AddEditGuestActivityLeading.this.updateTotal();
                } else {
                    AddEditGuestActivityLeading.this.openItemDetail(i, AddEditGuestActivityLeading.this.model.getArrayList().get(i), true);
                }
            }
        }));
    }
    ...
    public void openItemDetail(int i, GuestRowModel guestRowModel, boolean z) {
        Intent intent = new Intent(this.context, AddEditCompanionsActivityLeading.class);
        ...
        intent.putExtra(AddEditPaymentActivityLeading.EXTRA_MODEL, guestRowModel);
    ...
    private void saveDoc() {
        new BackgroundAsync(this.context, true, "", new OnAsyncBackground() {
            public void onPreExecute() {
                AddEditGuestActivityLeading.this.initDoc();
            }

            public void doInBackground() {
                AddEditGuestActivityLeading.this.fillDocData();
            }

            public void onPostExecute() {
                AddEditGuestActivityLeading.this.addingDocFooter();
            }
    ...
    public class FooterPageEvent extends PdfPageEventHelper {
        ...
        public void onEndPage(PdfWriter pdfWriter, Document document) {
            try {
                ...
                ColumnText.showTextAligned(directContent, 1, new Phrase("Created by : " + AddEditGuestActivityLeading.this.getString(R.string.app_name), new Font(Font.FontFamily.TIMES_ROMAN, 16.0f, 1)), document.leftMargin() + ((document.right() - document.left()) / 2.0f), document.bottom() + 10.0f, 0.0f);
            } catch (Exception e) {
                e.printStackTrace();
            }
        }
