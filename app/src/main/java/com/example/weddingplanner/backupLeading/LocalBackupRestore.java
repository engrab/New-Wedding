package com.example.weddingplanner.backupLeading;
    ...
    private void startLocalRestore(final BackupRestoreProgress backupRestoreProgress, String str, final boolean z) {
        new ZipUnZipAsyncTask(backupRestoreProgress, this.activity, false, (ArrayList<File>) null, str, "", new GetCompleteResponse() {
            ...
            public void getResponse(boolean z) {
                ...
                backupRestoreProgress.dismissDialog();
                if (z) {
                    Log.i("startLocalRestore", "getCurrentEvenId: " + AppPrefLeading.getCurrentEvenId(LocalBackupRestore.this.activity));
                    AppPrefLeading.setCurrentEvenId(LocalBackupRestore.this.activity, AppDataBase.getAppDatabase(LocalBackupRestore.this.activity).profileDao().getSelectedId());
                    Log.i("startLocalRestore", "getCurrentEvenId: " + AppPrefLeading.getCurrentEvenId(LocalBackupRestore.this.activity));
