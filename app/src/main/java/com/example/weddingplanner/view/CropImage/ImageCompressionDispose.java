package com.example.weddingplanner.view.CropImage;
...
public class ImageCompressionDispose {
    ...
    public Disposable getDisposeInstance(Context context2, String str, ImageListener imageListener) {
        this.context = context2;
        this.initialFilePath = str;
        this.imageCopy = imageListener;
        return Observable.fromCallable(new Callable() {
            /* class com.selfmentor.myweddingplanner.CropImage.$$Lambda$ImageCompressionDispose$msbhiCsY0zyrX9t1bnk8SUSrVc */

            @Override // java.util.concurrent.Callable
            public final Object call() {
                try {
                    return ImageCompressionDispose.this.lambda$getDisposeInstance$0$ImageCompressionDispose();
                } catch (Exception e) {
                    e.printStackTrace();
                }
                return null;
            ...
            /* class com.selfmentor.myweddingplanner.CropImage.$$Lambda$ImageCompressionDispose$oyrTonLjKGuPB8MTmi5eRAFw_8U */

            @Override // io.reactivex.functions.Consumer
            public final void accept(Object obj) {
//                ImageCompressionDispose.lambda$getDisposeInstance$1(ImageListener.this, (String) obj);
            }
        });
    }

    public  String lambda$getDisposeInstance$0$ImageCompressionDispose() throws Exception {
