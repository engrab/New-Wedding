package com.example.weddingplanner.all.roomsDB.cost;
...
@Entity(tableName = "costList")
public class CostRowModel extends BaseObservable implements Parcelable {
    public static final Creator<CostRowModel> CREATOR = new Creator<CostRowModel>() {
    ...
    private String eventId = AppPref.getCurrentEvenId(MyApp.getInstance());
