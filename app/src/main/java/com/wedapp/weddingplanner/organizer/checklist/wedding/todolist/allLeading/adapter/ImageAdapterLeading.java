...
import com.wedapp.weddingplanner.organizer.checklist.wedding.todolist.databinding.RowImageIconBinding;
import com.wedapp.weddingplanner.organizer.checklist.wedding.todolist.databinding.RowImageLargeBinding;

import java.util.ArrayList;

public class ImageAdapterLeading extends RecyclerView.Adapter {
    ...
    public ImageAdapterLeading(boolean z, Context context2, ArrayList<ImageRowModel> arrayList2, RecyclerItemClick recyclerItemClick2) {
...
//        }
    ...
    private class RowHolderLarge extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ImageAdapterLeading.this.selectionAll(false);
            ImageAdapterLeading.this.arrayList.get(getAdapterPosition()).setSelected(!arrayList.get(getAdapterPosition()).isSelected());
            ImageAdapterLeading.this.recyclerItemClick.onClick(getAdapterPosition(), 1);
