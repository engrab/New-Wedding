...
import com.wedapp.weddingplanner.organizer.checklist.wedding.todolist.allLeading.adapter.TaskAdapterLeading;
...
import com.wedapp.weddingplanner.organizer.checklist.wedding.todolist.allLeading.models.task.TaskListModel;
...
import com.wedapp.weddingplanner.organizer.checklist.wedding.todolist.databinding.ActivityTaskListBinding;
...
//                return;
    ...
    public void setRecycler() {
        ...
        this.binding.recycler.setAdapter(new TaskAdapterLeading(this.context, this.model.getArrayList(), new RecyclerItemClick() {
    ...
    public void openItemDetail(int position, int i2, TaskRowModel taskRowModel, boolean z) {
        ...
        intent.putExtra(AddEditTaskActivityLeading.EXTRA_POSITION, position);
    ...
    private int getSelectedPosById() {
        for (int i = 0; i < this.orderTypeList.size(); i++) {
            if (this.orderTypeList.get(i).getLabel().equalsIgnoreCase(AppPrefLeading.getSortTypeTask(this.context))) {
                return i;
            }
        }
        return 0;
    ...
    public void setOrderTypeListDialog() {
        ...
        this.dialogOrderTypeListBinding.recycler.setAdapter(new SelectionAdapterLeading(this.context, true, this.orderTypeList, new RecyclerItemClick() {
            public void onClick(int i, int i2) {
                ...
                AppPrefLeading.setSortTypeTask(context, ((SelectionRowModel) orderTypeList.get(selectedOrderTypePos)).getLabel());
                notifyAdapter();
                try {
    ...
    private void sortBy() {
        char c;
        String sortTypeTask = AppPrefLeading.getSortTypeTask(this.context);
        ...
        if (intent != null) {
            try {
                if (intent.hasExtra(AddEditTaskActivityLeading.EXTRA_MODEL)) {
                    this.rowModel = (TaskRowModel) intent.getParcelableExtra(AddEditTaskActivityLeading.EXTRA_MODEL);
